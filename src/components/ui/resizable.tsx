...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-50 flex h-6 w-4 items-center justify-center rounded-sm border bg-background shadow-sm hover:bg-accent hover:border-primary/50 transition-all cursor-col-resize" style={{ zIndex: 50 }}>
